...
class IrAttachment(models.Model):
    ...
    x_aa_ol_base_url = fields.Char(compute='_compute_ol_base_url')

    def _compute_ol_base_url(self):
        for rec in self:
            rec.x_aa_ol_base_url = self.env['ir.config_parameter'].sudo().get_param('web.base.url')
